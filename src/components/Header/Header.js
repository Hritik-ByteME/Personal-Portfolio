          ...
          <div className="header__nav-links" id="header__nav-links">
            <ul>
              ...
              <div className="header__nav-links-container">
                ...
                data-aos-delay="400"
                >
                <a href={`${process.env.PUBLIC_URL}/Hritik_Resume.pdf`} target='_blank' rel='noopener noreferrer'>
                  Resume
                </a>
                </li>
              ...
              <div className="header__social">
                <p className="header__linkedin">
                  <a href="https://www.linkedin.com/in/hritik-roshan-b20b9624a" rel="noopener noreferrer" target="_blank"><FontAwesomeIcon icon={faLinkedin} size="2x" /></a>
                </p>

                <p className='header__github'>
                  <a href="https://github.com/Hritik-ByteME" rel="noopener noreferrer" target="_blank"><FontAwesomeIcon icon={faGithub} size="2x" /></a>
                </p>

                <p className="header__instagram">
                  <a href="https://www.instagram.com/hriti.kgautam?igsh=MTVsNGU0aGNjeXRzaw==" rel="noopener noreferrer" target="_blank"><FontAwesomeIcon icon={faInstagram} size="2x" /></a>
                </p>

                <p className="header__facebook">
                  <a href="https://www.facebook.com/share/CqayyutFSq4zVXUa/?mibextid=qi2Omg" rel="noopener noreferrer" target="_blank"><FontAwesomeIcon icon={faFacebook} size="2x" /></a>
                </p>

                <p className="header__twitter">
                  <a href="https://x.com/DeepakK08947126?t=Fodb92chnqprPxGOvtmkYQ&s=09" rel="noopener noreferrer" target="_blank"><FontAwesomeIcon icon={faTwitter} size="2x" /></a>
                </p>
              </div>
            </ul>
          </div>
