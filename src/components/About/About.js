          ...
          <div className="about__details-container">
            ...
            >
              <Link to="/about/intro">
                ...
                <p>
                  I am <span>Your Hritik Roshan.</span> <br /> Highly passoinate
            ...
            >
              <Link to="/about/experience">
                ...
                <p>
                  <span>5 Year of experience.</span>
                  <br />I have over 5 Year of experience in developing
            ...
            >
              <Link to="/about/internships">
                ...
                <ul>
                  <li>
                    <span>Fintech Digitals Pvt Ltd</span> - Front-end Developer{" "}
                  </li>
                  <li>
                    <span>DEV Creations Pvt Ltd</span> - Project Assistant Manager{" "}
                  </li>
                  <li>
                    <span>SunRise Publication Pvt Ltd</span> - Printing Manager{" "}
                  </li>
                </ul>
              </Link>
            </div>
            ...
            >
              <Link to="/about/graduation">
                ...
                <p>
                  <span>J.K.L.U </span>
                  <br />
                  I persued Bachelor of Computer Applications Degree from J.k Lakshmipat University on the year 2022-2025
                </p>
              </Link>
            </div>
          </div>
